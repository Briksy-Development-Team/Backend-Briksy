...
final class PlanCapabilityResolver
{
    ...
    private const FEATURE_ALIASES = [
        ...
        'maximum_images' => ['Portfolio Photos', 'Service Images', 'Property Images'],
        'maximum_videos' => ['Portfolio Videos', 'Service Videos', 'Property Videos'],
        'video_upload' => ['Portfolio Videos', 'Video Upload'],
        'projects' => ['Projects'],
