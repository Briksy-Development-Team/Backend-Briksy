...
class OrganizationResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'builder_project_count' => (int) ($this->builder_project_count ?? 0),
            'pending_builder_projects_count' => (int) ($this->pending_builder_projects_count ?? 0),
            'property_count' => (int) ($this->property_count ?? 0),
            'service_count' => (int) ($this->service_count ?? 0),
