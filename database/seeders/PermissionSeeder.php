...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $definitions = [
            ...
            ['module' => 'property', 'action' => 'approve', 'name' => 'property.approve', 'display_name' => 'Approve Properties'],
            ['module' => 'property', 'action' => 'reject', 'name' => 'property.reject', 'display_name' => 'Reject Properties'],
            ['module' => 'property', 'action' => 'publish', 'name' => 'property.publish', 'display_name' => 'Publish Properties'],
            ['module' => 'property', 'action' => 'archive', 'name' => 'property.archive', 'display_name' => 'Archive Properties'],
            ['module' => 'property', 'action' => 'verify_location', 'name' => 'property.verify_location', 'display_name' => 'Verify Property Location'],
            ['module' => 'property', 'action' => 'unverify_location', 'name' => 'property.unverify_location', 'display_name' => 'Remove Property Location Verification'],
            ...
            ['module' => 'webhook', 'action' => 'view', 'name' => 'webhook.view', 'display_name' => 'View Webhooks'],
            ['module' => 'webhook', 'action' => 'create', 'name' => 'webhook.create', 'display_name' => 'Create Webhooks'],
            ['module' => 'webhook', 'action' => 'update', 'name' => 'webhook.update', 'display_name' => 'Update Webhooks'],
            ['module' => 'webhook', 'action' => 'delete', 'name' => 'webhook.delete', 'display_name' => 'Delete Webhooks'],
            ['module' => 'webhook', 'action' => 'retry', 'name' => 'webhook.retry', 'display_name' => 'Retry Webhook Deliveries'],
