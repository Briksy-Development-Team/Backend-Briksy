        ...
        return [
            [
                ...
                'features' => [
                    ...
                    $this->feature('Property Images', true, 5),
                    $this->feature('Property Videos', false, 0),
            ...
            [
                ...
                'features' => [
                    ...
                    $this->feature('Property Images', true, 15),
                    $this->feature('Property Videos', true, 3),
            ...
            [
                ...
                'features' => [
                    ...
                    $this->feature('Property Images', true, 25),
                    $this->feature('Property Videos', true, 5),
                    $this->feature('Custom Branding', true),
                    $this->feature('Analytics Dashboard', true),
            ...
            [
                ...
                'features' => [
                    ...
                    $this->feature('Property Images', true, 50),
                    $this->feature('Property Videos', true, 10),
                    $this->feature('Custom Branding', true),
                    $this->feature('Analytics Dashboard', true),
                    $this->feature('Priority Support', true),
                    $this->feature('Promo Offers', true, 10),
